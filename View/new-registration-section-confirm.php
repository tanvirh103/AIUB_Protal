...
<body>
    ...
    <tr><td><center><form method="post">
        Course ID:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" readonly value="<?php echo $row['courseId'] ?>" size="25"><br><br>
        Course Name:&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" readonly value="<?php echo $row['courseName'] ?>" size="25"><br><br>
        Section ID:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" readonly value="<?php echo $row['sectionId'] ?>" size="25"><br><br>
        Section :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" readonly value="<?php echo $row['sectionName'] ?>" size="25"><br><br>
        Room Number:&nbsp;&nbsp;<input type="text" readonly value="<?php echo $row['roomNumber'] ?>" size="25"><br><br>
        Time :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" readonly value="<?php echo $row['dayTime'] ?>" size="25"><br><br>
