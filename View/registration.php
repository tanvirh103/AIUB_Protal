...
<body>
    ...
    <center><br><form action="new-registration-section-confirm.php" method="post"><table border="1" width="auto" cellpadding="25" cellspacing="0" bordercolor="#004ca3"><font family="times new roman" size="4">
        <tr><td><center>
            Course Name:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select name="course" onchange="searchsection(this.value)"><option selected>Select Course</option>
                ...
                ?>
            Available Section:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select name="section" id="message"><option selected>Select Section</option></select><br><br>
